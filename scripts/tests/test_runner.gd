...
const SUITES := [
	...
	preload("res://scripts/tests/suites/test_game_over_ui.gd"),
	...
	preload("res://scripts/tests/suites/test_room_connection.gd"),
	preload("res://scripts/tests/suites/test_reconnect_backoff.gd"),
	preload("res://scripts/tests/suites/test_room_rematch.gd"),
